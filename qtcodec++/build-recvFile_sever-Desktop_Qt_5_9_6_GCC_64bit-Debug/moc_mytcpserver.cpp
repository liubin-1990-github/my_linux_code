...
#include "../recvFile_sever/mytcpserver.h"
...
QT_MOC_LITERAL(1, 12, 13), // "newDescripter"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "qintptr"
QT_MOC_LITERAL(4, 35, 16) // "socketDescriptor"

    },
    "MyTcpServer\0newDescripter\0\0qintptr\0"
    "socketDescriptor"
};
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDescripter((*reinterpret_cast< qintptr(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpServer::newDescripter)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpServer::newDescripter(qintptr _t1)
{
